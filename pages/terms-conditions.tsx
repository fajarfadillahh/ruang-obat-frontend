...
export default function TermsPage() {
  ...
  return (
    <>
      <NextSeo
        title="Syarat & Ketentuan Penggunaan Layanan RuangObat | RuangObat"
        description="Baca syarat & ketentuan penggunaan layanan RuangObat untuk memahami hak, kewajiban, serta aturan dalam mengakses dan menggunakan platform kami."
        canonical={currentUrl}
        openGraph={{
          url: currentUrl,
          title: "Syarat & Ketentuan Penggunaan Layanan RuangObat | RuangObat",
          description:
            "Baca syarat & ketentuan penggunaan layanan RuangObat untuk memahami hak, kewajiban, serta aturan dalam mengakses dan menggunakan platform kami.",
          site_name: "RuangObat",
        }}
      />

      <Layout
        title="Syarat & Ketentuan Penggunaan Layanan RuangObat"
        description="Baca syarat & ketentuan penggunaan layanan RuangObat untuk memahami hak, kewajiban, serta aturan dalam mengakses dan menggunakan platform kami."
      >
        <ButtonBack />
