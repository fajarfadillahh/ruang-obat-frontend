...
export default function ContactUsPage() {
  ...
  return (
    <>
      <Layout
        title="Hubungi Kami: RuangObat Siap Membantu Anda"
        ...
        <section className="base-container gap-24 [padding:50px_0_100px]">
          <div className="flex flex-wrap items-center justify-center gap-4">
            <div className="aspect-square rounded-full bg-purple p-6">
              <Image
                src="https://serveproxy.com/?url=https://ruangobat.is3.cloudhost.id/statics/images/ruangobat-logo/logo-ruangobat.svg"
                alt="logo"
                width={500}
                height={500}
                className="size-20"
