...
export default function CompanyPage() {
  ...
  return (
    <>
      <Layout
        title="Profil Perusahaan: PT. Pharmacy Cone Group"
      ...
      >
        <section className="base-container gap-24 [padding:50px_0_100px]">
          <div className="grid justify-items-center gap-4 text-center">
            <h1 className="text-4xl font-black capitalize -tracking-wide text-black md:text-6xl">
              PT. Pharmacy Cone Group
            </h1>

            <p className="max-w-[900px] font-medium leading-[170%] text-gray">
