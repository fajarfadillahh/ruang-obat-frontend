...
export default function AllArticlePage() {
  ...
  const [topic] = useQueryState("topik", { defaultValue: "" });
  ...
  return (
    <>
      ...
      >
        {router.query.topik ? <ButtonBack href="/artikel/topik" /> : null}
        ...
        {router.query.topik ? (
          <section className="base-container gap-1 py-[50px]">
            ...
            <p className="max-w-[500px] font-medium leading-[170%] text-gray">
              Kumpulan artikel pilihan mengenai {router.query.topik} untuk
