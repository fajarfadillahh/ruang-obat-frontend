  ...
  return (
    <>
      <Layout
        ...
        description="Nikmati berbagai artikel pilihan dengan pembahasan mendalam dan bahasa yang mudah dipahami. Dari tren terbaru seputar dunia Farmasi, tips and trik, kesehatan, dan lain-lain. Dapatkan informasi terpercaya dan inspirasi menarik hanya di sini."
      >
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div
                onClick={() =>
                  router.push(
                    `/artikel/${encodeURIComponent(newestArticleCard?.slug as string)}`,
                  )
                }
        ...
        <section className="base-container gap-4 pb-[100px]">
          <div className="flex items-center justify-between gap-4">
            ...
            <Button
              ...
              onClick={() => router.push("/artikel/semua")}
        ...
        <section className="base-container py-[50px]">
          <div className="flex flex-wrap items-center justify-between gap-8 rounded-xl border-2 border-gray-500/10 p-8">
            ...
            <Button
              color="secondary"
              endContent={<ArrowRight weight="bold" size={18} />}
              onClick={() => router.push(`/artikel/topik`)}
              className="font-bold"
            >
              Semua Topik Artikel
            </Button>
