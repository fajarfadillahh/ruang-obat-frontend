...
export default function DetailsPurchacePage({
  ...
  return (
    <>
      <Layout title="Detail Transaksi Saya">
        <section className="base-container">
          <ButtonBack />

          <div className="flex flex-wrap items-end justify-between gap-4 py-[50px]">
            <div className="grid gap-1">
              ...
              <p className="font-medium leading-[170%] text-gray">
                Lihat detail transaksi kamu disini.
              </p>
            </div>
          ...
          <div className="grid gap-4">
            ...
            <div className={wrapperSection}>
              ...
              <div className="grid gap-2 pt-5 sm:grid-cols-[max-content_1fr] sm:items-center">
                ...
                <div className="grid sm:gap-1">
                  ...
                  <div className="flex items-center gap-2 text-sm md:text-base">
                    ...
                    <Circle weight="fill" size={6} className="text-gray" />
