        ...
        <section className="base-container gap-8 [padding:50px_0_100px]">
          <div className="grid gap-1">
            ...
            <p className="font-medium leading-[170%] text-gray">
              Lihat history transaksi kamu sebelumnya disini.
            </p>
          </div>
          ...
          <div className="grid gap-4 xl:grid-cols-2 xl:items-start">
            {isLoading ? (
              ...
              data?.data.orders.map((order) => {
                ...
                return (
                  <div
                    ...
                    onClick={() =>
                      router.push(`/my/transactions/${order.order_id}`)
                    }
                  >
              ...
              <div className="grid justify-items-center gap-4 rounded-xl border-2 border-dashed border-gray/20 p-8 xl:col-span-2">
                <Image
                  src="https://s3.nevaobjects.id/ruang-obat-assets/statics/images/main-illustrations/img-no-data-upload.webp"
                  alt="no data image"
                  width={1000}
                  height={1000}
                ...
                <h3 className="max-w-[500px] text-center text-xl font-extrabold text-black">
                  Waduhh, kamu belum ada transaksi apapun nihh. Ayo, lakukan
                  transaksi sekarang...
                </h3>
              </div>
            )}
