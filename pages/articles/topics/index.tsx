  ...
  return (
    <>
      <Layout
        ...
        description="Jelajahi artikel kesehatan, farmasi, lifestyle, hingga tips & trik. Temukan bacaan relevan, informatif, dan bermanfaat hanya di RuangObat."
      >
                ...
                >
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-x-12">
                    {topic.items.map((item, index) => (
                      <Link
                        key={index}
                        href={`/articles/topics/${toSlug(item.name)}`}
