    ...
    <>
      ...
      >
        <section className="base-container items-center gap-6 [padding:50px_0_100px] xl:grid-cols-[1fr_550px]">
          ...
          <Image
            priority
            src="https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-illustration-program/img-private.webp"
            alt="private img"
            width={1000}
            height={1000}
        ...
        <section className="base-container items-center gap-12 [padding:100px_0_2rem] xl:grid-cols-[max-content_1fr]">
          <Image
            src="https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/logo/logo-ruang-private.webp"
            alt="logo program"
            width={1000}
            height={1000}
