    ...
    <>
      ...
      >
        ...
        <section className="base-container items-center gap-6 [padding:50px_0_100px] xl:grid-cols-[1fr_550px]">
          ...
          <Image
            priority
            src="https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-illustration-program/img-masuk-apoteker.webp"
        ...
        <section className="base-container justify-items-center [padding:100px_0_50px]">
          <Image
            src="https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/logo/logo-ruang-masuk-apoteker.webp"
            alt="logo program"
            width={1000}
            height={1000}
...
export const getServerSideProps: GetServerSideProps<{
  ...
  try {
    const [response, responseProvinces] = await Promise.all([
      ...
      fetch(
        "https://s3.nevaobjects.id/ruang-obat-assets/statics/provinces.json",
      ),
    ]);
