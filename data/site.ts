  ...
  classes: [
    {
      ...
      icon: "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/icon/icon-ruang-sarjana.webp",
    ...
    },
    {
      ...
      icon: "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/icon/icon-ruang-private.webp",
    ...
    },
    {
      ...
      icon: "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/icon/icon-ruang-skripsi.webp",
    ...
    },
    {
      id: 4,
      title: "Riset Farmasi",
      icon: "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/icon/icon-ruang-riset.webp",
    ...
    },
    {
      ...
      icon: "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/icon/icon-ruang-masuk-apoteker.webp",
    ...
    },
    {
      id: 6,
      title: "OSCE & UKMPPAI",
      icon: "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/new-logo-program/icon/icon-ruang-osce-ukmppai.webp",
  ...
  faqs: [
    {
      ...
      text: "RuangObat adalah platform Bimbel Private Farmasi No. 1 di Indonesia yang telah membantu 10.000+ mahasiswa farmasi di seluruh Indonesia. Kami menyediakan beragam program menarik untuk semua jenjang, mulai dari Video Pembelajaran, Skripsi dan Riset, hingga persiapan Masuk Apoteker, OSCE, dan Tryout UKMPPAI. Semua kebutuhan belajar farmasimu, cukup di satu tempat!",
      icon: Pill,
    },
    {
      id: 2,
      title: "Bagaimana cara mendaftar di RuangObat?",
      text: "Cukup klik tombol Register di pojok kanan atas, pilih program yang paling cocok buat kamu, dan ikuti langkah pendaftarannya. Setelah akun aktif, kamu bisa langsung mulai belajar dan akses semua materi tanpa ribet!",
      icon: NotePencil,
    },
    {
      id: 3,
    ...
    {
      id: 5,
      title: "Apakah semua materi bisa diakses kapan saja?",
