              ...
              <DropdownTrigger>
                <div className="inline-flex items-center gap-[10px] hover:cursor-pointer">
                  <Avatar
                    ...
                    showFallback
                    size="sm"
                    src={`${status == "authenticated" ? (session?.user.gender == "M" ? "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/avatar-img/avatar-male.svg" : "https://s3.nevaobjects.id/ruang-obat-assets/statics/images/avatar-img/avatar-female.svg") : null}`}
                    classNames={{
